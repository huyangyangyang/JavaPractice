package com.hy.practice.pdemo2;
...
public class Role {
    ...
    public void setFace(char gender) {
        ...
        if (gender == '男') {
            int r = random.nextInt(boyfaces.length);
            this.face = boyfaces[r];
        } else if (gender == '女') {
            int r = random.nextInt(girlfaces.length);
            this.face = girlfaces[r];
        } else
            this.face = "不男不女";
    }
    ...
    public void showRoleInfo() {
        System.out.println("我" + getName() + "是一个" + getFace() + "的" + getGender() + "人！");
    }
